...
const (
	TxnScan_Accept TxnScan = 0
)

var TxnScan_name = map[int32]string{
	0: "Accept",
}

var TxnScan_value = map[string]int32{
	"Accept": 0,
}

func (x TxnScan) String() string {
	return proto.EnumName(TxnScan_name, int32(x))
}

func (TxnScan) EnumDescriptor() ([]byte, []int) {
...
func (m *TxnUncommittedMVCCMetadata) GetSequence() uint32 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
type TxnConflictData struct {
	...
	WithUncommitted TxnUncommittedMVCCMetadata `protobuf:"bytes,2,opt,name=withUncommitted,proto3" json:"withUncommitted"`
	// WithCommitted conflicts with the committed data
	WithCommitted        hlcpb.Timestamp `protobuf:"bytes,3,opt,name=withCommitted,proto3" json:"withCommitted"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *TxnConflictData) GetOriginKey() []byte {
	if m != nil {
		return m.OriginKey
	}
	return nil
...
type TxnOperation struct {
	...
	// execute route.
	ToShard              uint64   `protobuf:"varint,7,opt,name=toShard,proto3" json:"toShard,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TxnOperation) GetToShard() uint64 {
	if m != nil {
		return m.ToShard
	}
	return 0
...
type TxnBatchRequestHeader struct {
	...
	// ToShard which shard the request dispatch to. 0 means the request need to
	// execute route.
	ToShard              uint64   `protobuf:"varint,3,opt,name=toShard,proto3" json:"toShard,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type ConsensusData struct {
	...
	RequestType uint64 `protobuf:"varint,1,opt,name=requestType,proto3" json:"requestType,omitempty"`
...
func (*ConsensusData) Descriptor() ([]byte, []int) {
	return fileDescriptor_4cec01c879ff9f20, []int{19}
}
func (m *ConsensusData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConsensusData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConsensusData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConsensusData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConsensusData.Merge(m, src)
}
func (m *ConsensusData) XXX_Size() int {
	return m.Size()
}
func (m *ConsensusData) XXX_DiscardUnknown() {
	xxx_messageInfo_ConsensusData.DiscardUnknown(m)
}

var xxx_messageInfo_ConsensusData proto.InternalMessageInfo

func (m *ConsensusData) GetRequestType() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("txnpb.TxnScan", TxnScan_name, TxnScan_value)
	...
	proto.RegisterType((*ConsensusData)(nil), "txnpb.ConsensusData")
}
...
var fileDescriptor_4cec01c879ff9f20 = []byte{
	...
	,
}
...
func (m *TxnMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	}
	{
		...
		i -= size
		i = encodeVarintTxnpb(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x52
	{
...
func (m *TxnRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.InfightWrites) > 0 {
		for k := range m.InfightWrites {
			...
			i--
			dAtA[i] = 0x8
			i = encodeVarintTxnpb(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.CompletedWrites) > 0 {
		for k := range m.CompletedWrites {
...
func (m *TxnUncommittedMVCCMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TxnConflictData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size, err := m.WithCommitted.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x1a
	{
		size, err := m.WithUncommitted.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TxnOpMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *KeySet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PointKeys) > 0 {
		for iNdEx := len(m.PointKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.PointKeys[iNdEx])
			copy(dAtA[i:], m.PointKeys[iNdEx])
			i = encodeVarintTxnpb(dAtA, i, uint64(len(m.PointKeys[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *TxnOperation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size, err := m.Impacted.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TxnBatchRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TxnBatchRequestHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TxnBatchResponseHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TxnBatchResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TxnError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AbortedError != nil {
		{
			size, err := m.AbortedError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UncertaintyError != nil {
		{
			size, err := m.UncertaintyError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ConflictWithCommittedError != nil {
		{
			size, err := m.ConflictWithCommittedError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ConflictWithCommittedError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UncertaintyError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AbortedError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConsensusData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.RequestType != 0 {
		i = encodeVarintTxnpb(dAtA, i, uint64(m.RequestType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ConsensusData) Size() (n int) {
	...
	_ = l
	if m.RequestType != 0 {
		n += 1 + sovTxnpb(uint64(m.RequestType))
	}
	l = len(m.Data)
	if l > 0 {
		n += 1 + l + sovTxnpb(uint64(l))
...
func skipTxnpb(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupTxnpb
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupTxnpb = fmt.Errorf("proto: unexpected end of group")
)
