...
type ShardLocalState struct {
	Shard                Shard     `protobuf:"bytes,1,opt,name=shard,proto3" json:"shard"`
	State                PeerState `protobuf:"varint,2,opt,name=state,proto3,enum=meta.PeerState" json:"state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func init() {
	proto.RegisterEnum("meta.PeerState", PeerState_name, PeerState_value)
...
var fileDescriptor_3b5ea8fe65782bcc = []byte{
	...
	,
}
