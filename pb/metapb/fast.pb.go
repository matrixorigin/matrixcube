...
func (m *ShardStats) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if err := m.Interval.FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StoreStats) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			if err := m.CpuUsages[len(m.CpuUsages)-1].FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 17:
			...
			if err := m.ReadIORates[len(m.ReadIORates)-1].FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
			...
			if err := m.WriteIORates[len(m.WriteIORates)-1].FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RemoveShardJob) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Replicas[len(m.Replicas)-1].FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShardPoolJob) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Pools[len(m.Pools)-1].FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShardPoolJobMeta) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.RangePrefix = dAtA[iNdEx:postIndex]
...
func (m *ShardExtra) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.DestroyingStatus.FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShardPool) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.AllocatedShards[len(m.AllocatedShards)-1].FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *AllocatedShard) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Purpose = dAtA[iNdEx:postIndex]
			if m.Purpose == nil {
				m.Purpose = []byte{}
			}
			iNdEx = postIndex
...
func (m *ShardsPoolCmd) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Create.FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if err := m.Alloc.FastUnmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EpochLease) FastUnmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EpochLease: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EpochLease: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
