...
type testStoreLimiter struct {
	opt *config.PersistOptions
}

func (s *testStoreLimiter) setup(t *testing.T) {
...
func TestCollect(t *testing.T) {
	...
	limiter := NewStoreLimiter(s.opt, nil)

	limiter.Collect(&metapb.StoreStats{})
...
func TestReplaceStoreLimitScene(t *testing.T) {
	...
	limiter.ReplaceStoreLimitScene(sceneAddPeer, limit.AddPeer)
	...
	limiter.ReplaceStoreLimitScene(sceneRemovePeer, limit.RemovePeer)
}
