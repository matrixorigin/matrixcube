...
// ResourceGroupRule resoruce group rule
...
func (m *ResourceGroupRule) Reset()         { *m = ResourceGroupRule{} }
func (m *ResourceGroupRule) String() string { return proto.CompactTextString(m) }
func (*ResourceGroupRule) ProtoMessage()    {}
func (*ResourceGroupRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b4d575d5a68dda, []int{16}
}
func (m *ResourceGroupRule) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResourceGroupRule) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResourceGroupRule.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ResourceGroupRule) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResourceGroupRule.Merge(m, src)
}
func (m *ResourceGroupRule) XXX_Size() int {
	return m.Size()
}
func (m *ResourceGroupRule) XXX_DiscardUnknown() {
	xxx_messageInfo_ResourceGroupRule.DiscardUnknown(m)
}

var xxx_messageInfo_ResourceGroupRule proto.InternalMessageInfo

func (m *ResourceGroupRule) GetID() uint64 {
	if m != nil {
		return m.ID
	}
	return 0
...
func (m *ResourceGroupRule) GetGroupID() uint64 {
	if m != nil {
		return m.GroupID
	}
	return 0
...
func (m *ResourceGroupRule) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ResourceGroupRule) GetGroupByLabel() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ResourceGroupRule)(nil), "metapb.ResourceGroupRule")
}
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *ResourceGroupRule) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResourceGroupRule) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ResourceGroupRule) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResourceGroupRule) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResourceGroupRule: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResourceGroupRule: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
