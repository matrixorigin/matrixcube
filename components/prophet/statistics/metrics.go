...
var (
	...
	shardStatusGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Namespace: "prophet",
			Subsystem: "resources",
			Name:      "status",
	...
	shardLabelLevelGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Namespace: "prophet",
			Subsystem: "resources",
			Name:      "label_level",
...
func init() {
	...
	prometheus.MustRegister(shardStatusGauge)
	...
	prometheus.MustRegister(shardLabelLevelGauge)
