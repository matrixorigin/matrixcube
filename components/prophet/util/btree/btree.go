...
// items containers items in a node.
type items []Item
...
// children containers child nodes in a node.
type children []*node
...
// indices containers indices of items in a node.
...
//
// BTree containers Item instances in an ordered structure, allowing easy insertion,
